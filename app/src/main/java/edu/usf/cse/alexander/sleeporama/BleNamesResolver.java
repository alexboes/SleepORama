...
This class has various methods to resolve UUIDs into BLE readable names.
It can resolve both services and characteristics, so this library is
quite useful.

A universally unique identifier (UUID) is a 128-bit (16 bytes) number that is guaranteed
(or has a high probability) to be globally unique.
...
public class BleNamesResolver {
	...
	static {
		...
		mServices.put("0000180d-0000-1000-8000-00805f9b34fb", "Heart Rate");//THIS IS ONE OF THE SERVICES FOR THE MIO-FUSE
