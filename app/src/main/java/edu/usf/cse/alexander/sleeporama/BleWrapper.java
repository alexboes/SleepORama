/*  Date: June 2015
  ...
  Class: BleWrapper
  This is the main class of the application issued by Bluetooth SIG.  Its a
  simplified wrapper into the Andorid BLE library that makes accessing and
  using the library easier.  It handles a lot of the complicated processing.
